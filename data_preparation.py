...
from math_utils import get_angular_velocity, get_linear_velocity, rotation_matrix_to_quaternion
"""
...
CONTACTNETS_INPUT_DIR = "/home/cnets-vision/mengti_ws/dair_pll/buddletrack/contactnets_cube/"
...
class DatasetManagement:
    ...
    def transform(self):
        ...
        print(lin_velocity)
        return np.hstack((np.hstack((q, self.translation)), np.hstack((ang_velocity, lin_velocity))))
...
if __name__ == "__main__":
    ...
    for frame_id in range(1, 4431):
        ...
        torch.save(torch.tensor(dataset.state), CONTACTNETS_INPUT_DIR+'{}.pt'.format(frame_id))
