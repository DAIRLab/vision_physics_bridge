...
class FrankaSim:
    '''Franka-only dataset simulation.
    '''
    def __init__(
        self,
        meshcat,
...
class ObjectSim:
    '''Object-only dataset simulation.
    '''
    def __init__(
        self,
        meshcat,
        ...
        self.model_file = FindResourceOrThrow(OBJECT_URDF_DIR)
...
class ObjectPlaybackSim:
    '''Object + robot dataset simulation.
    '''
    def __init__(
        self,
        meshcat,
    ...
    def save_depth_and_mask(self):
        ...
        img = Image.fromarray(depth_uint16)
        franka = FrankaSim(
            meshcat, self.positions[frame_id-1], frame_id, translation=cam_trans, axis_vec=cam_axis_vec
        )
        # import sys
