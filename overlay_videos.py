...
odom_bag_file = '/home/bibit/vision/bundlenets/cnets-data-generation/rosbags/odom_10.bag'
cam_bag_file = '/home/bibit/vision/bundlenets/cnets-data-generation/rosbags/raw_10.bag'
...
intrinsics = [380.2484436035156, 379.8265380859375,314.2138977050781,
              240.59800720214844,] # fx, fy, cx, cy
...
DATA_DIR = f"/home/bibit/vision/bundlenets/results/cube_1/bundlesdf_iteration_1/bundlesdf_id_00/ob_in_cam/"
ODOM_FILE_PATH = f"/home/bibit/vision/bundlenets/data/cube_1/annotated_poses/"
...
with TemporaryDirectory(prefix="ros-process-") as tmpdir:
    ...
    # -crf 18 TODO check this specifies the quality, 0 is lossless, 51 is worst.
    os.system('ffmpeg -y -r 30 -i ' + tmpdir + '/%07d.png -vcodec libx264 -preset slow -crf 18 ' + output_file)
