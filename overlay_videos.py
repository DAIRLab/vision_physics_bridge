...
class OverlayVideoGenerator:
    ...
    def __init__(self, vision_asset: str, tracking_bundlesdf_id: str,
        ...
        assert self.rgb_images.shape[0] == \
            self.bundlesdf_poses_in_cam.shape[0] == \
            self.tagslam_poses_in_world.shape[0], f'Inconsistent data sizes' + \
    ...
    def make_optimized_keyframe_overlay_images(self) -> None:
        ...
        for bsdf_i, bsdf_pose in zip(self.keyframe_indices, self.keyframe_tfs):
            ...
            T_WA = self.tagslam_poses_in_world[data_i]
            T_CB = bsdf_pose
...
def main_command(vision_asset: str, bundlesdf_id: str, nerf_bundlesdf_id: str,
                 cycle_iteration: int, all: bool, remote: bool):
